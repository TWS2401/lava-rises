...
execute unless score grace_timer RisingVars matches 1.. run scoreboard players set grace_timer RisingVars -1
execute unless score rising_timer RisingVars matches 1.. run scoreboard players set rising_timer RisingVars -1
